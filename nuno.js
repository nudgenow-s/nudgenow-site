...
const i18n = {
  ...
  en: {
    ...
    refund_step1_title:'Send a refund request email',refund_step1_desc:'Email hi@nudgenow.xyz with the subject "Refund Request".',
  ...
  fr: {
    ...
    refund_step1_title:'Envoyez un e-mail',refund_step1_desc:'Écrivez à hi@nudgenow.xyz avec l\'objet "Demande de remboursement".',
  ...
  vi: {
    ...
    refund_step1_title:'Gửi email yêu cầu',refund_step1_desc:'Email đến hi@nudgenow.xyz với tiêu đề "Yêu cầu hoàn tiền".',
