...
const i18n = {
  zh: {
    ...
    priv_s6_p2:'如需行使上述权利，请发送邮件至 privacy@nuno.app，我们将在 30 个工作日内响应。',
    priv_s7_title:'儿童隐私',
    ...
    priv_contact_email:'邮件：privacy@nuno.app（隐私相关事宜优先处理）',
    priv_contact_general:'一般咨询：hello@nuno.app',
    ...
    terms_s11_l1:'发送邮件至 hello@nuno.app 描述您的问题',
    ...
    terms_contact_email:'邮件：legal@nuno.app（条款相关事宜）',
    terms_contact_general:'一般咨询：hello@nuno.app',
    ...
    refund_step1_title:'发送退款申请邮件',refund_step1_desc:'发送邮件至 refund@nuno.app，主题注明"退款申请"。',
    ...
    refund_contact_email:'退款专线：refund@nuno.app（退款申请优先处理）',
    refund_contact_general:'一般客服：hello@nuno.app',
  ...
  en: {
    ...
    priv_s6_p2:'To exercise any of these rights, email privacy@nuno.app. We will respond within 30 business days.',
    ...
    priv_contact_email:'Email: privacy@nuno.app (privacy matters prioritised)',
    priv_contact_general:'General enquiries: hello@nuno.app',
    ...
    terms_contact_email:'Email: legal@nuno.app (Terms matters)',
    terms_contact_general:'General enquiries: hello@nuno.app',
    ...
    refund_contact_email:'Refund line: refund@nuno.app (refund requests prioritised)',
    refund_contact_general:'General support: hello@nuno.app',
  ...
  fr: {
    ...
    priv_s6_p2:'Pour exercer ces droits, écrivez à privacy@nuno.app. Réponse sous 30 jours ouvrés.',
    ...
    priv_contact_email:'E-mail : privacy@nuno.app (priorité aux questions de confidentialité)',
    priv_contact_general:'Questions générales : hello@nuno.app',
    ...
    terms_contact_email:'E-mail : legal@nuno.app',
    terms_contact_general:'Questions générales : hello@nuno.app',
    ...
    refund_contact_email:'Ligne remboursement : refund@nuno.app',
    refund_contact_general:'Support général : hello@nuno.app',
  ...
  vi: {
    ...
    priv_s6_p2:'Để thực hiện các quyền này, email privacy@nuno.app. Phản hồi trong vòng 30 ngày làm việc.',
    ...
    priv_contact_email:'Email: privacy@nuno.app (ưu tiên vấn đề bảo mật)',
    priv_contact_general:'Hỏi đáp chung: hello@nuno.app',
    ...
    terms_contact_email:'Email: legal@nuno.app',
    terms_contact_general:'Hỏi đáp chung: hello@nuno.app',
    ...
    refund_contact_email:'Đường dây hoàn tiền: refund@nuno.app (ưu tiên xử lý)',
    refund_contact_general:'Hỗ trợ chung: hello@nuno.app',
